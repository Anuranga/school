...
class StudentRegController extends Controller
{
    ...
    public function StudentRegUpdate(Request $request, $student_id): \Illuminate\Http\RedirectResponse
    {
    ...
    public function StudentUpdatePromotion(Request $request, $student_id): \Illuminate\Http\RedirectResponse
    {
        DB::transaction(function () use($request, $student_id){
            $user = User::where('id', $student_id)->first();
            $user->name = $request->name;
