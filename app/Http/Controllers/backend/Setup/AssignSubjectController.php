...
class AssignSubjectController extends Controller
{
    ...
    public function AssignSubjectStore(Request $request): \Illuminate\Http\RedirectResponse
    {
    ...
    public function AssignSubjectUpdate(Request $request, $class_id): \Illuminate\Http\RedirectResponse
    {
    ...
    public function AssignSubjectDelete($id): \Illuminate\Http\RedirectResponse
    {
