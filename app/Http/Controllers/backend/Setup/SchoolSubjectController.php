...
class SchoolSubjectController extends Controller
{
    ...
    public function SubjectStore(Request $request): \Illuminate\Http\RedirectResponse
    {
    ...
    public function SubjectUpdate(Request $request, $id): \Illuminate\Http\RedirectResponse
    {
    ...
    public function SubjectDelete($id): \Illuminate\Http\RedirectResponse
    {
        $data = SchoolSubject::find($id);
        $data->delete();
