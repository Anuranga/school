                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($allData as $key  => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <img id="showImage" src="{{(!empty($value['student']['image'])) ? url('upload/student_images/'.$value['student']['image']) : url('upload/no_image.jpg')}}"
                                                         style="width: 60px; height: 60px; border: 1px solid #000000">
                                                </td>
                                                <td>{{ $value->year_id }}</td>
                                                <td width="25%">
